  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        const avatarRes = await axios.post('http://localhost:5000/api/users/avatar', formData, {
      ...
      const profileRes = await axios.put('http://localhost:5000/api/users/profile', profileData, config);
